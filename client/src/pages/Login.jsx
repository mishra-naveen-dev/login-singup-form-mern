...
export default function Login() {
    ...
    const handleOnChange = (e) => {
        setLoginInput(preValue => ({ ...preValue, [e.target.name]: e.target.value }))
        console.log(loginInput)
    }

    return (
        <div
            className="__login w-full h-[calc(100dvh-60px)]  bg-slate-800 text-white flex justify-center
         items-center flex-col gap-3"
        >
            <h1 className=" text-3xl  justify-center items-center">Login Page</h1>
